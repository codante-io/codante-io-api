...
Route::group([
    ...
    Route::crud('technical-assessment', 'TechnicalAssessmentCrudController');
    Route::crud('backups', 'BackupCrudController');
    Route::crud('backup-disks', 'BackupDiskCrudController');
