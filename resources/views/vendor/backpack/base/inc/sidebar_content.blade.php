...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('user') }}"><i class="nav-icon la la-group"></i> Users</a>
</li>
...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('backups') }}"><i class="nav-icon la la-question"></i>
        Backups</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('backup-disks') }}"><i
