...
<li class="nav-item nav-dropdown">
    ...
    <ul class="nav-dropdown-items">
        <li class="nav-item"><a class="nav-link" href="{{ backpack_url('track') }}"><i class="nav-icon la la-list-alt"></i>
        Tracks</a></li>
       <li class="nav-item"><a class="nav-link" href="{{ backpack_url('track-section') }}"><i
            class="nav-icon la la-list-alt"></i>
        Track Sections</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('track-item') }}"><i class="nav-icon la la-list-alt"></i>
        Track Items</a></li>
    </ul>
</li>
